/*! STT2EXTAT - since v1.0.3 - 2015-10-23http://www.jevuska.com/2015/06/28/injeksi-manual-keyword-add-onsextension-plugin-seo-searchterms-tagging-2/
 * package STT2EXTAT
...
(function ($) {
                    ...
                    source: function ( b, c ) {
						var d = $("input#title").val(),
							e = {
                                ...
                                "wpnonce": stt2extatL10n[1],
                                "max": 10,
                                "query": d
                            };
						$.post( ajaxurl, e, function ( a ) {
							c(a);
							return false;
						}, "json" )
					},
        ...
        function stt2extat_update_settings( b ) {
            var c = {
                "action": "stt2extat_update_settings",
                "wpnonce": stt2extatL10n[1],
                "maxchar": b
            };
            $.post( ajaxurl, c, function ( a ) {
        ...
        function stt2extat_get_searchterms_post_js() {
            ...
            if ( '' != b ) {
				...
				var c = {
					"action": "stt2extat_list_terms_post",
					"id": b,
					"wpnonce": stt2extatL10n[1]
				};
				$.post( ajaxurl, c, function ( a ) {
        ...
        function stt2extat_searchterm_hits_js() {
            ...
            $("i.termlist").on("click", function (e) {
                ...
                t = setTimeout(function () {
                    stt2extat_searchterm_hits_db_js(a, meta_count, stt2extatL10n[1]);
                    e.preventDefault()
                }, 2000);
                return false
            });
            $("i.termcnt").on("click", function (e) {
                ...
                t = setTimeout(function () {
                    stt2extat_searchterm_hits_db_js(a, b, stt2extatL10n[1]);
                    e.preventDefault()
                }, 2000);
                return false
            });
        ...
        function search_relevant( b ) {
            var c = $("#notmatchfeat").val(),
        ...
        function stt2extat_resize_textarea() {
            $.each($("textarea#insertterms"), function () {
