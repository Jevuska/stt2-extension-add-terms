...
Manage your search terms better, extended version of SEO SearchTerms Tagging 2 plugin. Add search terms into single post manually. Search the terms that relevant of post content as well as WordPress search default algorithm. JavaScript browser enabled required and the latest modified version of SEO SearchTerms Tagging 2 plugin installed ( https://github.com/Jevuska/stt2-extension-add-terms/releases/tag/STT2-v1.535 ). 
...
* add minify version jquery-stt2extat.min.js
